<template>
   ...
   <div class="border rounded px-2 pt-2 absolute right-2 top-28">
      <label class="swap swap-flip text-9xl">
         <!-- this hidden checkbox controls the state -->
         <input type="checkbox" v-model="highlight" />
         <div class="swap-on">
            <svg class="bg-yellow-200" width="32" height="32" viewBox="0 0 12.7 15.875" version="1.1" x="0px" y="0px"><g transform="translate(0,-284.29998)"><path style="" d="m 10.032413,284.90066 a 0.52383499,0.52383499 0 0 0 -0.3813971,0.14366 l -7.547848,7.18044 a 3.9088925,3.9088925 0 0 1 -0.8743686,2.94091 l -0.69969058,0.6997 0.97202628,0.53433 0.46355,-0.46354 a 5.2938727,5.2938727 0 0 1 2.9915378,-1.00097 l 7.0703812,-7.43159 a 0.52383499,0.52383499 0 0 0 0,-0.72192 l -1.635575,-1.71927 a 0.52383499,0.52383499 0 0 0 -0.358616,-0.16175 z m -0.01773,0.19741 a 0.3256272,0.3256272 0 0 1 0.232568,0.10077 l 1.636051,1.71927 a 0.3256272,0.3256272 0 0 1 0,0.44907 l -0.07284,0.076 -2.1978147,-2.09031 0.1746779,-0.16485 a 0.3256272,0.3256272 0 0 1 0.2273568,-0.0899 z m -0.5451743,0.39222 2.2045083,2.09651 -6.7644432,7.11016 -2.5589971,-2.43447 z m -7.1447818,7.02076 2.3523046,2.23862 a 5.4920805,5.4920805 0 0 0 -0.471805,0.0538 l -1.8918766,-1.80041 a 4.1071003,4.1071003 0 0 0 0.011377,-0.49196 z m -0.039264,0.74001 1.6779345,1.59576 a 5.4920805,5.4920805 0 0 0 -2.0510499,0.88367 l -0.4779963,-0.50281 a 4.1071003,4.1071003 0 0 0 0.8511117,-1.97662 z m -0.9849644,2.1239 0.4609571,0.4842 -0.2955925,0.29559 -0.6097852,-0.33589 z" fill="#000000" stroke="none"/></g><text x="0" y="27.7" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">Created by Phạm Thanh Lộc</text><text x="0" y="32.7" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">from the Noun Project</text></svg>
         </div>
         <div class="swap-off">
